                        ...
                        <div key={p.id} className="flex items-center gap-2 bg-slate-900/90 p-1.5 rounded-lg border border-slate-800">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="text-[10px] text-slate-400">
                              เล่น {getMatchCountForDisplay(p)} Match • มือ {p.skillLevel}
                    ...
                    {poolForSlot2.map((p) => (
                      <div key={p.id} className="flex items-center gap-2 bg-slate-900/90 p-2 rounded-lg border border-slate-800">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-[10px] text-slate-400">เล่น {getMatchCountForDisplay(p)} Match • มือ {p.skillLevel}</div>
                        </div>
                          ...
                          {stagedA1 && (
                            <>
                              <span className="text-[10px] text-slate-400 block">
                                เล่น {getMatchCountForDisplay(stagedA1)} Match • มือ {stagedA1.skillLevel}
                              </span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {stagedA2 && (
                            <>
                              <span className="text-[10px] text-slate-400 block">
                                เล่น {getMatchCountForDisplay(stagedA2)} Match • มือ {stagedA2.skillLevel}
                              </span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {stagedB1 && (
                            <>
                              <span className="text-[10px] text-slate-400 block">
                                เล่น {getMatchCountForDisplay(stagedB1)} Match • มือ {stagedB1.skillLevel}
                              </span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {stagedB2 && (
                            <>
                              <span className="text-[10px] text-slate-400 block">
                                เล่น {getMatchCountForDisplay(stagedB2)} Match • มือ {stagedB2.skillLevel}
                              </span>
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-950 text-slate-400 uppercase text-[10px] tracking-wider border-b border-slate-800">
                  <tr>
                    ...
                    <th className="px-3 py-2.5 text-center">Match ที่เล่นแล้ว</th>
                        ...
                        <td className="px-3 py-3 text-center">
                          ...
                          {player.registrationType === 'walkin' && (player.walkInPenaltyMatches ?? 1) > 0 ? (
                            <div className="text-[10px] text-amber-400 font-medium">
                              คิวคำนวณ: {getEffectiveMatchCountForDisplay(player)} Match
                            </div>
                          ) : null}
                        </td>
